...
namespace ChuiWenChiu.Win32
{
    ...
    public class UserActivityHook
    {
        ...
        /// </summary>
        public static ChuiWenChiu.Win32.User32.HookProc MouseHookProcedure;
        /// <summary>
        /// Declare KeyboardHookProcedure as HookProc type.
        /// </summary>
        public static ChuiWenChiu.Win32.User32.HookProc KeyboardHookProcedure;
        ...
        public void Start(bool InstallMouseHook, bool InstallKeyboardHook)
        {
            ...
            if (hMouseHook == 0 && InstallMouseHook)
            {
                ...
                MouseHookProcedure = new ChuiWenChiu.Win32.User32.HookProc(MouseHookProc);
                //install hook
            ...
            {
                // Create an instance of HookProc.
                KeyboardHookProcedure = new ChuiWenChiu.Win32.User32.HookProc(KeyboardHookProc);
                //install hook
        ...
        public void Stop(bool UninstallMouseHook, bool UninstallKeyboardHook, bool ThrowExceptions)
        {
            ...
            {
                //uninstall hook
                int retMouse = User32.UnhookWindowsHookEx(hMouseHook);
        ...
        private int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)
        {
            ...
            if ((nCode >= 0) && (KeyDown != null || KeyUp != null || KeyPress != null))
            {
                ...
                {
                    bool isDownShift = ((User32.GetKeyState(VK_SHIFT) & 0x80) == 0x80 ? true : false);
                    bool isDownCapslock = (User32.GetKeyState(VK_CAPITAL) != 0 ? true : false);
